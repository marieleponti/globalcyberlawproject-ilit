...
urlpatterns = [
    ...
    path('nonint-eu-states-to-eu-sov', views.eu_comparison_nonint_view, name='nonint_eu_states_to_eu'),
    path('nonint-non-eu-states-to-eu-sov', views.eu_non_eu_comparison_nonint_view,
         name='nonint_non_eu_states_to_eu'),
